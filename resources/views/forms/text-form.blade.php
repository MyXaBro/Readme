<section class="adding-post__text tabs__content tabs__content--active">
    ...
    {!! Form::open(['route' => 'add-text', 'class' => "adding-post__form form"]) !!}
    <div class="form__text-inputs-wrapper">
        <div class="form__text-inputs">
            ...
            <div class="adding-post__textarea-wrapper form__textarea-wrapper">
                {!! htmlspecialchars_decode(Form::label('content', 'Текст поста  <span class="form__input-required">*</span>', ['class' => "adding-post__label form__label"]))!!}
                <div class="form__input-section @if($errors->any('content')) ? form__input-section--error : @endif">
                    {!!  Form::textarea('content', null, ['class' => "adding-post__textarea form__textarea form__input", 'placeholder' => "Введите текст публикации"]) !!}
                    <button class="form__error-button button" type="button">!<span
                            class="visually-hidden">Информация об ошибке</span></button>
                    <div class="form__error-text">
                        <h3 class="form__error-title">Заголовок сообщения</h3>

  ...
  <div class="header__wrapper page__header-wrapper container">
    <div class="header__logo-wrapper page__logo-wrapper">
      <a class="header__logo-link header__logo-link--active">
        <img class="header__logo" src="/resources/img/logo.svg" alt="Логотип readme" width="172" height="32">
      </a>
      ...
      <nav class="header__nav">
        <ul class="header__user-nav page__user-nav">
          <li class="page__user-item">
            ...
            <a class="header__user-button header__register-button button button--transparent" href="/resources/views/registration.php">Регистрация</a>
          </li>
        </ul>
      </nav>
    </div>

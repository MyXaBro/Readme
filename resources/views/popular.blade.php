                    ...
                    <ul class="popular__sorting-list sorting__list">
                        <li class="sorting__item sorting__item--popular">
                            <a class="sorting__link sorting__link--active"
                               href="{{ route('popular.sort', ['sort' => 'popular']) }}">
                    ...
                    <ul class="popular__filters-list filters__list">
                        ...
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--photo button"
                               href="{{ route('popular.filter', 'photo') }}">
                        ...
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--video button"
                               href="{{ route('popular.filter', 'video') }}">
                        ...
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--text button"
                               href="{{ route('popular.filter', 'text') }}">
                        ...
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--quote button"
                               href="{{ route('popular.filter', 'quote') }}">
                        ...
                        <li class="popular__filters-item filters__item">
                            <a class="filters__button filters__button--link button"
                               href="{{ route('popular.filter', 'link') }}">
                ...
                @if (count($posts) > 0)
                    @if ($posts->previousPageUrl())
                        <a class="popular__page-link popular__page-link--prev button button--gray"
                           href="{{ $posts->previousPageUrl() }}">Предыдущая страница</a>
                    @endif

                    @if ($posts->nextPageUrl())
                        <a class="popular__page-link popular__page-link--next button button--gray"
                           href="{{ $posts->nextPageUrl() }}">Следующая страница</a>
                    @endif

                    <div class="pagination">
                        @for ($i = 1; $i <= $posts->lastPage(); $i++)
                            <a href="{{ $posts->url($i) }}"
                               class="{{ $posts->currentPage() === $i ? 'active' : '' }}">{{ $i }}</a>
                        @endfor
                    </div>
                @endif
            </div>
